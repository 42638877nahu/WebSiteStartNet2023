...
namespace WebSiteStartNet2023.Controllers
{
    public class CVsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Localidad,Provincia,CodigoArea,TeléfonoCelular,Email,NombreArchivo,Fecha")] CV cV)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Localidad,Provincia,CodigoArea,TeléfonoCelular,Email,NombreArchivo,Fecha")] CV cV)
        {
            if (id != cV.Id)
            {
                return NotFound();
