...
namespace WebSiteStartNet2023.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.Rubros = _context.RubrosClientes;
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreFantasia,NombreLogo,Fecha,Orden,VisibleEnHome,IdRubroCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreFantasia,NombreLogo,Fecha,Orden,VisibleEnHome,IdRubroCliente")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
