...
namespace WebSiteStartNet2023.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,NombreSlider,Detalle,Fecha,NombreHome")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,NombreSlider,Detalle,Fecha,NombreHome")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
