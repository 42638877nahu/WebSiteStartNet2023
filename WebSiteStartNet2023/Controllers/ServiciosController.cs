...
namespace WebSiteStartNet2023.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,NombreSlider,Detalle,Fecha,NombreHome")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,NombreSlider,Detalle,Fecha,NombreHome")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
